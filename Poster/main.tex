...
\noindent
\begin{minipage}[c]{0.25\textwidth}
\textbf{Variación del número de capas $m$.}
...
\item \vspace{-0.75em} Las resonancias de orden superior se concentran hacia menores $\lambda$ según \eqref{lr}; ajustando $L$ puede imponerse $\lambda_0=\lambda_1$. El aumento del número de capas introduce resonancias secundarias, ya que cada par puede comportarse como una cavidad débilmente acoplada.
\end{itemize}
}
...
\qrcode[hyperlink, height=3.5in]{https://github.com/LucasBerredo/MultInterference}
